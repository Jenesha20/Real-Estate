  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form className='flex flex-col gap-4'>
        <img src={currentUser.avatar} alt='profile' className='rounded-full h-20 w-20 object-cover cursor-pointer self-center mt-2' />
      ...
      <div className='flex justify-between mt-5'>
        <span lassName='text-red-700 cursor-pointer'>Delete Account</span>
